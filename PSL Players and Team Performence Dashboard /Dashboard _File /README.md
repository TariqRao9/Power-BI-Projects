# **PSL Players and Team Performance**
...
Total Runs (81K): Represents the cumulative runs scored by all players in the dataset, highlighting the overall scoring volume of the PSL.

Batting Average (25.39): Indicates the average runs scored per dismissal, reflecting general batting efficiency across seasons.

Sum of Sixes (3049): Shows the total number of sixes hit, emphasizing the aggressive, power-hitting nature of T20 cricket.

Total Fours (7358): Captures boundary scoring through fours, complementing six-hitting analysis.

Total Wickets (2909): Represents total wickets taken, showcasing bowling impact in the league.

Average Economy (5.54): Reflects the overall bowling economy rate, indicating how efficiently bowlers control runs.
...
It compares the average total catches and average total dismissals, showing the relative contribution of catches versus stumpings/run-outs.
...
Multan Sultans emerge as the most successful team by win percentage.

Islamabad United and Peshawar Zalmi follow closely, indicating consistent performance.

Quetta Gladiators, Lahore Qalandars, and Karachi Kings show comparatively lower win percentages.
...
Players like Shaheen Shah Afridi, Hasan Ali, and Rashid Khan stand out as strike bowlers.

The chart emphasizes wicket-taking ability as a key factor in match success.
...
Babar Azam leads the chart, underlining his consistency and dominance.

Other top contributors include Fakhar Zaman, Mohammad Rizwan, and Shoaib Malik.
...
It captures the high-scoring nature of the PSL alongside effective bowling performances.
